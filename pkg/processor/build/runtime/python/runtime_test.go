...
func (suite *PythonTestSuite) TestBaseImageName() {
	...
	for _, params := range []struct {
	...
	}{
		{
			...
			"latest",
			"amd64",
			"quay.io/loop/processor-py3.6-alpine:latest-amd64",
		},
		{
			"2.7",
			"",
			"latest",
			"amd64",
			"quay.io/loop/processor-py2.7-alpine:latest-amd64",
		},
		{
			"2.7",
			"jessie",
			"latest",
			"amd64",
			"quay.io/loop/processor-py2.7-jessie:latest-amd64",
		},
		{
			"",
			"jessie",
			"latest",
			"amd64",
			"quay.io/loop/processor-py3.6-jessie:latest-amd64",
		},
		{
			"",
			"",
			"label",
			"arch",
			"quay.io/loop/processor-py3.6-alpine:label-arch",
		},
		{
			"3.1",
			"",
